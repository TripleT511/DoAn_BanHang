...
<div style="text-align: center;">
    <a href="{{ route('admin.showFormReset', ['token' => $token]) }}" style="display: inline-block; padding: 10px 15px; background-color: #004dda; color: #fff; border-radius: 7px; text-decoration: none;">Đặt lại mật khẩu</a>
</div>
